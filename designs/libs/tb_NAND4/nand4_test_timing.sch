...
Vin3 C 0 DC 3.3
*Vin4 D 0 DC 3.3
Vin4 D 0 PULSE(0 3.3 1n 10p 10p 10n 20n)
*.tran 10p 50n
.save all
...
meas tran tplh_A TRIG v(D) VAL=1.65 RISE=1 TARG v(Y) VAL=1.65 FALL=1 
meas tran tphl_A TRIG v(D) VAL=1.65 FALL=1 TARG v(Y) VAL=1.65 RISE=1 
...
"}
C {code_shown.sym} -840 140 0 0 {name=SPICE1 only_toplevel=false 
value=
