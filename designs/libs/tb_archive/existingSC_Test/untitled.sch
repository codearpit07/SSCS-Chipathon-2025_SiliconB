...
S {}
E {}
N -510 -460 -510 -430 {name=IN1
lab=VDD}
N -510 -370 -510 -340 {lab=GND}
N -510 -370 -510 -340 {lab=GND}
C {code_shown.sym} -480 -160 0 0 {name=SPICE only_toplevel=false 
value=
...
"}
C {code_shown.sym} -440 200 0 0 {name=MEASURE only_toplevel=false value=
"
...
"}
C {vsource.sym} -510 -400 0 0 {name=V2 value=3.3 savecurrent=false}
C {lab_wire.sym} -510 -345 0 0 {name=p6 sig_type=std_logic lab=GND}
C {lab_wire.sym} -510 -445 0 0 {name=p9 sig_type=std_logic lab=VDD}
